    ...
    <nav class="app-sidebar d-none d-lg-flex flex-column">
        ...
        <ul class="nav flex-column gap-1">
            <?php foreach ($menuItems as $item): ?>
                <li class="nav-item">
                    <a href="<?php echo DOMAIN . 'secretaire/' . $item['file']; ?>" class="nav-link<?php echo $currentPath === $item['file'] ? 'active' : ''; ?>">
    ...
    <div class="offcanvas offcanvas-start bg-dark text-white" tabindex="-1" id="adminSidebarOffcanvas" aria-labelledby="adminSidebarLabel">
        ...
        <div class="offcanvas-body">
            <ul class="nav flex-column gap-1">
                <?php foreach ($menuItems as $item): ?>
                    <li class="nav-item">
                        <a href="<?php echo DOMAIN . 'secretaire/' . $item['file']; ?>" class="nav-link d-flex align-items-center gap-2<?php echo $currentPath === $item['file'] ? 'active' : ''; ?>">
                            <i class="bi                                                                                 <?php echo $item['icon']; ?>"></i>
                            <?php echo $item['label']; ?>
                        </a>
                    </li>
