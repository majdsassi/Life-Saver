...
<div class="container-fluid mt-4">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
        ...
        <a href="<?php echo DOMAIN . 'admin/actions/add_don.php'; ?>" class="btn btn-primary">
            + Enregistrer un Don
        </a>
    </div>
                        ...
                        <tbody>
                            <?php foreach ($dons as $don): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo DOMAIN . 'medecin/test.php?id_don=' . urlencode($don['id_don']); ?>" class="btn btn-sm btn-outline-primary<?php echo $don['statut'] !== 'EN STOCK' ? ' disabled' : ''; ?>">
                                            Tests
                                        </a>
                                    </td>
                                </tr>
