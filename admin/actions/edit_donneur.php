<?php
    ...
    if ($donneurId <= 0) {
        header('Location: ' . DOMAIN . 'admin/donneurs.php?error=missing_id');
        exit;
    }
    ...
    if (! $donneur) {
        header('Location: ' . DOMAIN . 'admin/donneurs.php?error=not_found');
        exit;
    }
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (! $errors) {
            ...
            header('Location: ' . DOMAIN . 'admin/donneurs.php?message=202');
            exit;
        }
